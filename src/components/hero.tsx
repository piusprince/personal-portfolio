    ...
    <section className="relative flex flex-col justify-center min-h-[70vh] px-4 pt-10">
      <div className="max-w-4xl mx-auto text-center flex flex-col items-center z-10">
        <motion.div {...fadeInUp} className="mb-6">
          <Headline
            as="h1"
            className="text-5xl md:text-7xl lg:text-8xl tracking-tighter leading-[1.1] font-extrabold pb-2 bg-clip-text text-transparent bg-linear-to-b from-white to-white/70"
          >
            {heading}
          </Headline>
        </motion.div>
        ...
        >
          {email && (
            <Button
              size="lg"
              className="rounded-full px-8 text-sm font-bold shadow-[0_0_20px_rgba(59,130,246,0.3)]"
              asChild
            >
              <a href={`mailto:${email}`}>
          ...
          <Button
            variant="outline"
            size="lg"
            className="rounded-full px-8 text-sm font-semibold glass-panel"
            asChild
          >
